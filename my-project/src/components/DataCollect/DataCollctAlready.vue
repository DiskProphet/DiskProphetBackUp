<template>
    <div class="table">
        <b-table :items="items" :fields="fields" class="dataCollectReady">
            <template slot="down_name" slot-scope="row"> <b-form-checkbox-group id="radioboxes3" v-model="selected"><b-form-radio  :value="row.value">{{row.value}}</b-form-radio></b-form-checkbox-group>
</template>
