<template>
    <div class="table">
        <b-table :items="items" :fields="fields" class="dataCollectAll"><template slot="down_name" slot-scope="row"><b-form-checkbox-group id="radioboxes1" v-model="selected"><b-form-radio  :value="row.value" type="radio" @change="showMsgFromDataCollectAllChild(row.value)">{{row.value}}</b-form-radio></b-form-checkbox-group>
</template>
...
<script>
    ...
    export default {
        props: ['showMsgFromDataCollectAllChild'],
        data() {
            return {
                testLive:'/',
                selected: [],
